...
// 	protoc        v3.11.2
// source: contextlogic/autobots/v1/stream.proto
...
func (x *StreamDataRequest) Reset() {
	*x = StreamDataRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_contextlogic_autobots_v1_stream_proto_msgTypes[0]
...
func (*StreamDataRequest) Descriptor() ([]byte, []int) {
	return file_contextlogic_autobots_v1_stream_proto_rawDescGZIP(), []int{0}
}
...
func (x *StreamData) Reset() {
	*x = StreamData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_contextlogic_autobots_v1_stream_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamData) Descriptor() ([]byte, []int) {
	return file_contextlogic_autobots_v1_stream_proto_rawDescGZIP(), []int{1}
}
...
func (x *StreamDataResponse) Reset() {
	*x = StreamDataResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_contextlogic_autobots_v1_stream_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamDataResponse) Descriptor() ([]byte, []int) {
	return file_contextlogic_autobots_v1_stream_proto_rawDescGZIP(), []int{2}
}
...
var File_contextlogic_autobots_v1_stream_proto protoreflect.FileDescriptor

var file_contextlogic_autobots_v1_stream_proto_rawDesc = []byte{
...
var (
	file_contextlogic_autobots_v1_stream_proto_rawDescOnce sync.Once
	file_contextlogic_autobots_v1_stream_proto_rawDescData = file_contextlogic_autobots_v1_stream_proto_rawDesc
)

func file_contextlogic_autobots_v1_stream_proto_rawDescGZIP() []byte {
	file_contextlogic_autobots_v1_stream_proto_rawDescOnce.Do(func() {
		file_contextlogic_autobots_v1_stream_proto_rawDescData = protoimpl.X.CompressGZIP(file_contextlogic_autobots_v1_stream_proto_rawDescData)
	})
	return file_contextlogic_autobots_v1_stream_proto_rawDescData
}

var file_contextlogic_autobots_v1_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_contextlogic_autobots_v1_stream_proto_goTypes = []interface{}{
	(*StreamDataRequest)(nil),  // 0: contextlogic.autobots.v1.StreamDataRequest
	(*StreamData)(nil),         // 1: contextlogic.autobots.v1.StreamData
	(*StreamDataResponse)(nil), // 2: contextlogic.autobots.v1.StreamDataResponse
}
var file_contextlogic_autobots_v1_stream_proto_depIdxs = []int32{
	1, // 0: contextlogic.autobots.v1.StreamDataRequest.streamData:type_name -> contextlogic.autobots.v1.StreamData
	1, // 1: contextlogic.autobots.v1.StreamDataResponse.streamData:type_name -> contextlogic.autobots.v1.StreamData
	0, // 2: contextlogic.autobots.v1.Stream.BiDirectStream:input_type -> contextlogic.autobots.v1.StreamDataRequest
	0, // 3: contextlogic.autobots.v1.Stream.ClientStream:input_type -> contextlogic.autobots.v1.StreamDataRequest
	0, // 4: contextlogic.autobots.v1.Stream.ServerStream:input_type -> contextlogic.autobots.v1.StreamDataRequest
	2, // 5: contextlogic.autobots.v1.Stream.BiDirectStream:output_type -> contextlogic.autobots.v1.StreamDataResponse
	2, // 6: contextlogic.autobots.v1.Stream.ClientStream:output_type -> contextlogic.autobots.v1.StreamDataResponse
	2, // 7: contextlogic.autobots.v1.Stream.ServerStream:output_type -> contextlogic.autobots.v1.StreamDataResponse
...
func init() { file_contextlogic_autobots_v1_stream_proto_init() }
func file_contextlogic_autobots_v1_stream_proto_init() {
	if File_contextlogic_autobots_v1_stream_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_contextlogic_autobots_v1_stream_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contextlogic_autobots_v1_stream_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contextlogic_autobots_v1_stream_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_contextlogic_autobots_v1_stream_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_contextlogic_autobots_v1_stream_proto_goTypes,
		DependencyIndexes: file_contextlogic_autobots_v1_stream_proto_depIdxs,
		MessageInfos:      file_contextlogic_autobots_v1_stream_proto_msgTypes,
	}.Build()
	File_contextlogic_autobots_v1_stream_proto = out.File
	file_contextlogic_autobots_v1_stream_proto_rawDesc = nil
	file_contextlogic_autobots_v1_stream_proto_goTypes = nil
	file_contextlogic_autobots_v1_stream_proto_depIdxs = nil
}
...
func (c *streamClient) BiDirectStream(ctx context.Context, opts ...grpc.CallOption) (Stream_BiDirectStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[0], "/contextlogic.autobots.v1.Stream/BiDirectStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamClient) ClientStream(ctx context.Context, opts ...grpc.CallOption) (Stream_ClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[1], "/contextlogic.autobots.v1.Stream/ClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamClient) ServerStream(ctx context.Context, in *StreamDataRequest, opts ...grpc.CallOption) (Stream_ServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[2], "/contextlogic.autobots.v1.Stream/ServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
var _Stream_serviceDesc = grpc.ServiceDesc{
	ServiceName: "contextlogic.autobots.v1.Stream",
	...
	Metadata: "contextlogic/autobots/v1/stream.proto",
}
